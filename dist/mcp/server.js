...
import { saveMemory, generateMemoryId, buildEmbeddingText, getMemoriesByCommit, getMemoriesByFile, } from "../memory/saveMemory.js";
import { getRepoId } from "../git/repoId.js";
import { redactSecrets } from "../memory/redactSecrets.js";
import { SearchMemoryInput, SaveMemoryInput, GetCommitMemoryInput, GetFileMemoriesInput, } from "./tools.js";
...
export async function createMcpServer() {
    const server = new Server({ name: "coding-memory", version: "0.1.0" }, { capabilities: { tools: {} } });
